...
| Answer length cap | The most tokens the answer may hold. Empty leaves it to the provider. |
| Context       | Choose what to send to the model        |
| Send the snapshots as images | Also send the ticked snapshots as pictures. Off by default. |
